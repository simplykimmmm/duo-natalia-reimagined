...
const fr: Record<string, string> = {
  ...
  "about.nvdm.bio":
    "La violoniste Natalia van der Mersch \u2013 Steurer est née à Essen, en Allemagne. Son talent musical a été reconnu très tôt par le violoniste et pédagogue russe de renommée mondiale Zakhar Bron. Il l\u2019a acceptée dans sa classe à l\u2019Académie de musique de Lübeck. Elle a ensuite été invitée par le célèbre virtuose du violon russe Igor Oistrakh à sa nouvelle classe de maître au Conservatoire Royal de Bruxelles, où elle a terminé son examen de concert avec grande distinction.\n\nNatalia van der Mersch a reçu plusieurs récompenses au cours de ses études, notamment le prix Parke-Davis à Freiburg et le prix Aalto à Essen. Elle a fait ses débuts en concert avec orchestre en interprétant le concerto pour violon d\u2019Antonín Dvořák avec l\u2019Orchestre philharmonique slovène au Meistersingerhalle de Nuremberg. Depuis, elle est apparue sur des scènes de concerts nationaux et internationaux avec le Kölner Kammerorchester, le Hamburger Philharmonisches Orchester, les Essener Philharmoniker, le Polish Chamber Philharmonic, l\u2019Orchestre de Chambre National de Toulouse et avec le Campus Orchestra Israel.\n\nNatalia a été invitée à de nombreux festivals de musique, dont le Schleswig Holstein Musik Festival, le Rheingau Festival et le Gstaad Music Festival. Son premier enregistrement sur CD a été réalisé en 1990 \u00ABLes Meisterschüler de Zakhar Bron\u00BB avec Vadim Repin, Maxim Vengerov et David Garrett suivi de \u00ABNatalia Steurer\u00BB avec le pianiste Alexander Markovich, \u00ABSalut d\u2019amour\u00BB avec le pianiste Luc Devos, \u00ABLiebesfreud\u00BB avec le pianiste Eduard Kiprsky et \u00ABLa Folia\u00BB avec Natalia Kovalzon.\n\nCes trois derniers CD ont été enregistrés pour la Fondation Lea-Rose pour la recherche sur les maladies musculaires rares, une fondation créée par elle et son mari après le décès prématuré de leur fille atteinte de SMA (amyotrophie spinale) en 2006.\n\nNatalia van der Mersch, mère de six enfants, vit avec sa famille à Luxembourg.",
  "about.nk.title": "Natalia Kovalzon",
  "about.nk.role": "Piano",
  "about.nk.bio":
